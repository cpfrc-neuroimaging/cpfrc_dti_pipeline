...
def verifyModules():
    ...
    while True:
            ...
            if loaded == "yes" or loaded == "y" or loaded == "Yes" or loaded == "YES":
                ...
                print("\nplease load mrtrix and afni using the following command:\n")
                print("module load mrtrix AFNI/linux_centos_7_64\n")
